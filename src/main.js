...
$('#workerInfoButton').click(function(event) {
  ...
  $('#planetYears').html('<li> Earth: ' + astronaut.earthYears + ' Years Old </li>' + '<li> Mercury: ' + astronaut.mercuryYears + ' Years Old </li>' + '<li> Venus: ' + astronaut.venusYears + ' Years Old </li>' + '<li> Mars: ' + astronaut.marsYears + ' Years Old </li>' + '<li> Jupiter: ' + astronaut.jupiterYears + ' Years Old');
  ...
  if (longLife === false) {
    ...
    $('#workLifespan').html('<li>ALERT!</li> POTENTIAL <li></li>PROFIT<li>OPPORTUNITY</li><li>SEE NOTE</li><li></li><li></li>');
    $('#lifespanAlert').show();
  }
});
